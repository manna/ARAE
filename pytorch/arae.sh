...
# Train
# python2 train_arae.py --data_path ./Data/snli_lm --cuda --no_earlystopping
# python2 train_arae.py --data_path ./Data/snli_lm --cuda --kenlm_path ./kenlm --min_epochs 6
python2 train_arae.py --data_path ./Data/mnli_lm_telephone --cuda --no_earlystopping --epochs 25
# python2 train_arae.py --data_path ./Data/mnli_lm_fiction --cuda --kenlm_path ./kenlm --min_epochs 10 --epochs 50
